...
// Short codes for a tight space — the invoice fee tag (lib/invoicing.js)
// and any compact list column that can't afford the full label above.
export const ADMINISTRATION_METHOD_CODES = {
  dispense: 'DIS',
  sc: 'SC',
  im: 'IM',
};
