...
// Buckets invoice line items by which record they billed for — every
// ordinary invoice has exactly one bucket (section_label null throughout,
// so nothing about how it looks changes), while a merged invoice (see
// migration 114) also has one bucket per merged-in case, each labeled with
// that case's own heading and listed after the primary case's own
// (unlabeled) charges.
