...
export async function buildTaxInvoicePdf({ invoice, lineItems, clinic, client, patientName }) {
  ...
  const clinicContactBits = [clinic?.phone || null, clinic?.email || null].filter(Boolean);
