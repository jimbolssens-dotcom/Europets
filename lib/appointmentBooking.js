...
// standard spay/castration durations below; anything more involved
// (a non-standard surgery) isn't self-bookable — the portal form tells
// them to contact the clinic directly instead.

export const CLIENT_APPOINTMENT_TYPES = ['consult', 'spay', 'castration'];
