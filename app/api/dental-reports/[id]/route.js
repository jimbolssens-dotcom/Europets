...
// PATCH /api/dental-reports/:id  -> edit any of its fields — used both for
//                                   the existing fields and for saving the
//                                   vet-reviewed postop_instructions once
//                                   they've approved an AI draft (see
//                                   app/api/dental-reports/[id]/generate-postop).

import { supabase } from '@/lib/supabaseClient';
import { NextResponse } from 'next/server';

const EDITABLE_FIELDS = ['performed_by', 'findings', 'procedures_performed', 'notes', 'postop_instructions'];
