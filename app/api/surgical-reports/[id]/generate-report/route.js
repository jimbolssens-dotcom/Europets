// app/api/surgical-reports/[id]/generate-report/route.js
// POST -> generate the AI client report from this report's own manually
// typed fields (procedure_name/notes) — the same generation a dictation
...
export async function POST(request, { params }) {
  try {
    const data = await generateReportFromManualEntry('surgical_report', params.id);
