...
export async function POST(request, { params }) {
  ...
  if (isBloodTest(data.goods_services?.name || data.type))
    return NextResponse.json({ error: 'AI summarization is disabled for blood tests — review the attached file directly.' }, { status: 400 });
